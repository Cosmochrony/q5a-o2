...
\begin{document}
  ...
  \paragraph{Keywords.}
    spectral atomicity, admissible projection, Mosco convergence, Dirichlet forms, Heisenberg group, Weil
    representation, spectral gap, Fourier modes, finite-dimensional reduction
